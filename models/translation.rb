  ...
  def self.defaults
    {
      ...
      :position => 'position',
      :positions => 'positions',      
      :account_tagship => 'substance of interest',
      :account_tagships => 'substances of interest',
      :add_another_account_tagship => 'add another substance of interest',      
      :news => 'news',
      :map => 'map',
      :stats => 'stats',
      :calendar => 'calendar',
      ...
      :'mongoid.attributes.account.unsubscribe_meetup' => "Don't send me email notifications of meetups near me",
      :'mongoid.attributes.account.unsubscribe_new_member' => "Don't send me email notifications of new members near me",
      :'mongoid.attributes.account.unsubscribe_trust' => "Don't send me email notifications when people trust me",      
      ...
      :'mongoid.attributes.event.end_time' => 'To',
      :'mongoid.attributes.event.location' => 'Where',
      ...
      :filter_by_account_tagship => 'filter by substance of interest',
      :member_of => 'member of',
      :at => 'at',
